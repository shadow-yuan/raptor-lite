...
#ifndef __RAPTOR_LITE_UTILS_SYNC__
#define __RAPTOR_LITE_UTILS_SYNC__
...
public:
    ConditionVariable() {
        RaptorCondVarInit(&_cv);
    }
    ~ConditionVariable() {
        RaptorCondVarDestroy(&_cv);
    }
    ...
    void Signal() {
        RaptorCondVarSignal(&_cv);
    }
    void Broadcast() {
        RaptorCondVarBroadcast(&_cv);
    }
...
#endif  // __RAPTOR_LITE_UTILS_SYNC__
